...
private double error = 0;
    ...
    */
    public DriveSubsystem() {
        pidDrive = new PIDController(.003, 0.000, 0.0001);
...
rightMotorControllerLeader.getEncoder().setPosition(0);
...
//    - rightMotorControllerLeader.getEncoder().getPosition());
    ...
    public void periodic() {
        ...
        if (Timer.getFPGATimestamp() - lastDashboardUpdateTime > 1)
        {
            ...
            SmartDashboard.putNumber("PID Setpoint", pidDrive.getSetpoint());
            SmartDashboard.putNumber("Pos Diff", leftMotorControllerLeader.getEncoder().getPosition()
                - rightMotorControllerLeader.getEncoder().getPosition());
    ...
    public void arcadeDrive(double speed, double direction){
        ...
        {
            speed = 0;
            // This is the new direction setpoint
            //pidDrive.setSetpoint(diffBetweenEncoderPosition);
        }
