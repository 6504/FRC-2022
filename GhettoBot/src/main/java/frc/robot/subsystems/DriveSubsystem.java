...
rightMotorControllerLeader.getEncoder().setPositionConversionFactor(2.216470588235294);
    ...
    public void periodic() {
        ...
        {
            SmartDashboard.putNumber("Drive Position Left", leftMotorControllerLeader.getEncoder().getPosition());
            SmartDashboard.putNumber("Drive Position Right", rightMotorControllerLeader.getEncoder().getPosition());
            SmartDashboard.putNumber("Drive Speed Left", leftMotorControllerLeader.getEncoder().getVelocity());
            SmartDashboard.putNumber("Drive Speed Right", rightMotorControllerLeader.getEncoder().getVelocity());

            lastDashboardUpdateTime = Timer.getFPGATimestamp();

            SmartDashboard.putNumber("Faults", leftMotorControllerLeader.getFaults());
        }
    }
    ...
    private final double m_maxDriveSpeed = 58000;
    private final double m_maxTurnSpeed = 58000;

    public void arcadeDrive(double speed, double direction){
        m_pidleftController.setReference(speed * m_maxDriveSpeed + direction * m_maxTurnSpeed, ControlType.kVelocity);
        m_pidrightController.setReference(speed * m_maxDriveSpeed - direction * m_maxTurnSpeed, ControlType.kVelocity);
