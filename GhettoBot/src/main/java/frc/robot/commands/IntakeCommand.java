...
public class IntakeCommand extends CommandBase {
    ...
    @Override
    public void execute() {
        if (RobotContainer.getInstance().getPS4DriveController().getSquareButtonPressed())
            m_IntakeSubsystem.intakeIn();
        if (RobotContainer.getInstance().getPS4DriveController().getCrossButtonPressed())
            m_IntakeSubsystem.intakeOff();
        if (RobotContainer.getInstance().getPS4DriveController().getTriangleButtonPressed())
