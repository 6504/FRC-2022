...
public class AutonomousCommand extends CommandBase {
    ...
    @Override
    public void execute() {
        CANSparkMax masterMotor = m_driveSubsystem.getMasterMotor();
        RelativeEncoder masterEncoder = masterMotor.getEncoder();

        masterEncoder.setPosition(1); //move wheel one rotation
